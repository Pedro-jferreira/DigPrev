 ...
 final Section s1 = Section(
    ...
    questions: <Question>[
      Question(
        ...
        question:
        'Atualmente você tem ocupação remunerada ou faz '
            'trabalho voluntário fora de sua casa?',
        placeholder: 'Selecione uma opção',
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Inclui qualquer trabalho pago (CLT, autônomo, '
      ...
      Question(
        id: ObjectId().hexString,
        question:
        'Quantos dias e qual o tempo (horas e minutos) durante '
            'uma semana normal você realiza atividades vigorosas como:',
        placeholder: 'Selecione uma opção',
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Considere apenas atividades físicas intensas '
        ...
        explanatoryTexts: <ExplanatoryTexts>[
          const ExplanatoryTexts(
            explanatoryText:
            'Trabalho de construção pesada, levantar e '
      ...
      Question(
        id: ObjectId().hexString,
        question:
        'Quantos dias e qual o tempo durante uma semana normal '
            'você realiza atividades moderadas como:',
        placeholder: 'Selecione uma opção',
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Inclua apenas atividades físicas de intensidade '
        ...
        explanatoryTexts: <ExplanatoryTexts>[
          const ExplanatoryTexts(
            explanatoryText:
            'Levantar e transportar pequenos objetos, '
      ...
      Question(
        id: ObjectId().hexString,
        question:
        'Quantos dias e qual o tempo durante uma semana '
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Considere apenas caminhadas realizadas como parte '
      ...
      Question(
        id: ObjectId().hexString,
        question:
        'Quando você caminha como parte do seu trabalho '
            'remunerado ou voluntário, a que passo você geralmente anda?',
        placeholder: 'Selecione uma opção',
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Informe o ritmo médio da sua caminhada durante '
  ...
  final Section s2 = Section(
    ...
    questions: <Question>[
      Question(
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Considere apenas o tempo gasto dentro do veículo '
      ...
      Question(
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Considere apenas o tempo em que você pedala como '
      ...
      Question(
        id: ObjectId().hexString,
        question:
        'Quando você anda de bicicleta, a que velocidade você '
            'costuma pedalar?',
        placeholder: 'Selecione uma opção',
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Informe a velocidade média ao pedalar, considerando '
      ...
      Question(
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Considere apenas caminhadas realizadas como meio de '
        ...
        explanatoryTexts: <ExplanatoryTexts>[
          const ExplanatoryTexts(
            explanatoryText:
            'Ir ao grupo de convivência/idosos, igreja, '
      ...
      Question(
        id: ObjectId().hexString,
        question:
        'Quando você caminha para ir de um lugar a outro, a que '
            'passo você normalmente anda?',
        placeholder: 'Selecione uma opção',
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Informe o ritmo médio da sua caminhada ao se '
  ...
  final Section s3 = Section(
    id: 4.3,
    title:
    'Atividade Física em Casa, Tarefas Domésticas e Cuidado '
        'com a Família',
    maxValue: 0,
    typeCalculate: TypeCalculate.ATIVIDADE_FISICA,
    textUnderBar: <StageLabel>[],
    questions: <Question>[
      Question(
        ...
        explanatoryTexts: <ExplanatoryTexts>[
          const ExplanatoryTexts(
            explanatoryText:
            'Carpintaria, cortar lenha, serrar madeira, '
      ...
      Question(
        ...
        explanatoryTexts: <ExplanatoryTexts>[
          const ExplanatoryTexts(
            explanatoryText:
            'Carregar pequenos objetos, limpar garagem, '
  ...
  final Section s4 = Section(
    ...
    questions: <Question>[
      Question(
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Considere apenas caminhadas realizadas no seu '
      ...
      Question(
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Inclua apenas atividades físicas intensas '
        ...
        explanatoryTexts: <ExplanatoryTexts>[
          const ExplanatoryTexts(
            explanatoryText:
            'Correr, nadar rápido, pedalar rápido, '
  ...
  final Section s5 = Section(
    ...
    questions: <Question>[
      Question(
        ...
        supportingText: 'Selecione uma opção',
        tooltipText:
        'Informe o tempo total que você passa sentado em '
  ...
  final List<Section> subsections = <Section>[s1, s2, s3, s4, s5];*/
/*
}
*/
