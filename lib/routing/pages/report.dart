...
import 'package:digprev_flutter/ui/report/result/result_Screen.dart';
        ...
        pageBuilder:
            (BuildContext context, GoRouterState state) =>
                MaterialPage<dynamic>(
                  child: ResultScreens(
                    viewModel: context.watch<ResultViewModel>(),
                  ),
                ),
        routes: <RouteBase>[
          GoRoute(
            name: AppRoutes.resultChart.name,
            ...
            pageBuilder: (BuildContext context, GoRouterState state) {
              ...
              return MaterialPage<dynamic>(
                child: reportPageWidget(
                  id: id,
                  viewModel: context.watch<ReportViewModel>(),
                ),
              );
            },
          ),
